    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
          <div>
            <h2 id="about-heading" className="text-balance text-2xl font-bold sm:text-3xl lg:text-4xl">
              {t.about.title}
            </h2>
          ...
          <div className="flex flex-col justify-center rounded-2xl border border-border bg-card/60 p-6 sm:p-8">
            <h3 className="text-lg font-semibold sm:text-xl">{t.about.flowTitle}</h3>
